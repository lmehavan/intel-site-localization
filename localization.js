...
(() => {
  ...
  const ar = {
    ...
    sources:'استكشف المصادر',sourcesIntro:'تستند المحطات التاريخية إلى صفحات تاريخ إنتل وأخبارها وتقارير مسؤوليتها المؤسسية. صور الخط الزمني رسوم توضيحية مولّدة بالذكاء الاصطناعي.',reflectionKicker:'تأملات المشروع',reflectionHeading:'ما تعلمته من التوطين.',reflectionAiHeading:'الذكاء الاصطناعي الاحتمالي',reflectionAi:'قد تكون الترجمة أو الصور المولّدة بالذكاء الاصطناعي مفيدة في إعداد النماذج الأولية، لكنها احتمالية؛ فقد تبدو واثقة مع احتوائها على خطأ في حقيقة أو دلالة ثقافية أو تفصيل من تفاصيل سهولة الوصول. استخدمت المراجعة البشرية ومصادر إنتل الرسمية وأوصافًا واضحة للصور للتحقق من النتيجة.',reflectionInterviewHeading:'سؤال مقابلة',reflectionInterview:'سأسأل مهندس توطين: كيف تختبرون تخطيطات اتجاه الكتابة من اليمين إلى اليسار مع مستخدمين حقيقيين، خصوصًا عندما يغيّر النص المترجم طوله وترتيب القراءة؟ ستساعد الإجابة على ربط الاختبارات الآلية بتجربة الزوار الناطقين بالعربية.',reflectionLinkedinHeading:'منشور LinkedIn',reflectionLinkedin:'أنشأت خطًا زمنيًا سهل الوصول لاستدامة إنتل باللغتين الإنجليزية والعربية. يجمع المشروع بين استجابة Bootstrap واكتشاف RTL تلقائيًا وحوارات صديقة للوحة المفاتيح ومحتوى يستند إلى المصادر ونموذج نشرة إخبارية تم التحقق منه. التوطين أكثر من ترجمة؛ فهو يغيّر التخطيط والتفاعل والثقة.',footer:'© 2026 لوكا مزهافانادزه · توطين موقع إنتل',student:'مشروع دراسي مستقل، وليس موقعًا رسميًا لشركة إنتل.',backTop:'العودة إلى الأعلى ↑',
